              ...
              <table className="w-full">
                <thead className="bg-gray-900">
                  <tr className="text-left text-gray-400 text-sm">
                    ...
                    <th className="px-6 py-4 font-semibold text-center">Score Diff</th>
                  </tr>
                </thead>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-center">
                          <div className="text-white font-semibold">{entry.totalGames}</div>
                        </td>
                        ...
                        {/* Losses */}
                        <td className="px-6 py-4 text-center">
                          <div className="text-red-400 font-semibold">{entry.losses}</div>
                        </td>

                        {/* Win Rate */}
                        <td className="px-6 py-4 text-center">
                          <div className="inline-block">
                            <div className="text-white font-bold text-lg">{entry.winRate}%</div>
